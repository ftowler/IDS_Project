...
#Background image
style_xaringan(
  title_slide_background_image = "https://wallpaperaccess.com/full/2847328.jpg"
)
```
...
# aim for doing this project:
# Figure out whether simply car bodies improve racing overall or not
...
background-image: url("https://thedrum-media.imgix.net/thedrum-prod/s3/news/tmp/689017/adobestock_118548565.jpeg?w=1280&ar=default&fit=crop&crop=faces,edges&auto=format")
background-size: cover


## Introduction
---
Due to introduce a budget cap and rules change in 2022 FORMULA 1, race cars have to use less complex and intricate bodies. This situation leads to less distribute airflow, in theory. Our project aim is seeking whether these new rules are precious or not.
...
---
## Constructor Points and Driver Championship for each season
...
kable(head(result_df), format = "html")
