...
Our research project was to determine whether Formula 1's 2022 season rule changes had the intended effect of improving the competition by allowing for more overtaking and thus a closer race. This is of interest because it allows us to see if the emphesis of downforce, new aerodynamic wings and nose and budget caps had the desired effect.
...
We used Formula 1 World Championship data, the whole data set goes from 1950-2023 but we used 2009-2023 as that's when modern racing regulations were changed.
