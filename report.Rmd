...
In conclusion the regulation changes overall have not increased competitiveness but has allowed individual races to become more competitive. The qualifying race times still trended upwards after the regulations; this shows that budget caps have not reduced the difference in car performance. The split time analysis does show a reduction since the introduction of the regulations showing that races were closer. The change in aerodynamics regulations having the intended effect of allowing races to follow each other more closely. The constructor and driver points standard deviation continued their trend of increasing, the regulation changes working as intended would hopefully see a drop in standard deviation but the trend of an increasing gap between high and low performing drivers and constructors has not been slowed. Overall, the dramatic changes in aerodynamics have allowed races to become closer but budget constraints haven’t stopped major constructors from dominating another season using their superior infrastructure. As this is the first year of these new cars, it may just take more time for all the teams to understand the new regulations and become more competitive.
