...
constructorPointsPerSeason %>%
  summarise(
    sd_2009 = sd(`2009`, na.rm = TRUE) / 17,
    sd_2010 = sd(`2010`, na.rm = TRUE) / 19,
    sd_2011 = sd(`2011`, na.rm = TRUE) / 19,
    sd_2012 = sd(`2012`, na.rm = TRUE) / 20,
    sd_2013 = sd(`2013`, na.rm = TRUE) / 19,
    sd_2014 = sd(`2014`, na.rm = TRUE) / 19,
    sd_2015 = sd(`2015`, na.rm = TRUE) / 19,
    sd_2016 = sd(`2016`, na.rm = TRUE) / 21,
    sd_2017 = sd(`2017`, na.rm = TRUE) / 20,
    sd_2018 = sd(`2018`, na.rm = TRUE) / 21,
    sd_2019 = sd(`2019`, na.rm = TRUE) / 21,
    sd_2020 = sd(`2020`, na.rm = TRUE) / 17,
    sd_2021 = sd(`2021`, na.rm = TRUE) / 22,
    sd_2022 = sd(`2022`, na.rm = TRUE) / 22
  ) %>%
  ...
  labs(
    title = "Standard Deviation of points for Each Season",
    x = "Season",
